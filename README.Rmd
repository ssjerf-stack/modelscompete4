...
- ✓ **Nested models** → chi‑square difference test (`lavTestLRT`)
- ✓ **Non‑nested models** → Vuong test (`nonnest2::vuongtest`)
- ✓ **Fit indices**: AIC, BIC, CFI, TLI, RMSEA, SRMR, χ², df, p‑value
- ✓ **Automatic model naming** – use your own names
- ✓ **Bootstrap support** – standard errors and confidence intervals
